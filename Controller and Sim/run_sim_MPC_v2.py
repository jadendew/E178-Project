...
OUTPUT_CSV = r"sim_out_MLP_MPC_v2.csv"
...
SAVE_PLOTS = True
PLOT_OUTPUT_DIR = "mpc_output_plots_v2"
PLOT_DPI = 200

SAVE_ANIMATION = True
ANIMATION_OUTPUT_DIR = "mpc_output_animation_v2"
ANIMATION_FILENAME = "mpc_v2_animation.mp4"  # falls back to .gif if mp4 fails
ANIMATION_FPS = 30
ANIMATION_DPI = 140

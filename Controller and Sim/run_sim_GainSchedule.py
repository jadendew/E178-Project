...
OUTPUT_CSV = r"sim_out_basePID.csv"
...
# Saving outputs
SAVE_PLOTS = True
PLOT_OUTPUT_DIR = "base_PID_plots"
PLOT_DPI = 200

SAVE_ANIMATION = True
ANIMATION_OUTPUT_DIR = "basePID_output_animation"
ANIMATION_FILENAME = "basePID_animation.mp4"  # falls back to .gif if ffmpeg/mp4 saving fails
ANIMATION_FPS = 30
ANIMATION_DPI = 140

...
OUTPUT_CSV = r"sim_out_mlp_mpc_fixed_thrust_heading_roll_filtered.csv"
...
MPC_Q_PITCH = 3.0
MPC_Q_ROLL = 0.8
MPC_Q_RATES = [0.035, 0.030, 0.035]
MPC_Q_ALPHA = 0.20
MPC_Q_BETA = 0.35
MPC_R_CONTROL = [0.020, 0.020]
MPC_R_DELTA_CONTROL = [0.15, 0.15]
...
MPC_USE_OUTPUT_FILTER = True
MPC_OUTPUT_FILTER_TAU_TRANSIENT_S = 0.08
MPC_OUTPUT_FILTER_TAU_STEADY_S = 0.35
MPC_OUTPUT_FILTER_DEADBAND_DEG = [0.08, 0.08]

# Conditions that define "near steady-state" for the stronger filter.
MPC_FILTER_HEADING_ERR_DEG = 3.0
MPC_FILTER_PITCH_ERR_DEG = 1.0
MPC_FILTER_ROLL_ERR_DEG = 4.0
MPC_FILTER_P_RATE_DEG_S = 8.0
MPC_FILTER_Q_RATE_DEG_S = 8.0
MPC_FILTER_R_RATE_DEG_S = 8.0

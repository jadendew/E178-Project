...
OUTPUT_CSV = r"sim_out_mlp_mpc_fixed_thrust_heading_roll_warmstart.csv"
...
MPC_Q_PITCH = 3.0
MPC_Q_ROLL = 0.8
MPC_Q_RATES = [0.045, 0.040, 0.045]
MPC_Q_ALPHA = 0.20
MPC_Q_BETA = 0.35
MPC_R_CONTROL = [0.020, 0.020]
MPC_R_DELTA_CONTROL = [0.30, 0.30]
...
MPC_HEADING_DEADBAND_DEG = 0.50
MPC_PITCH_DEADBAND_DEG = 0.25
...
HEADING_TO_ROLL_GAIN = 0.45      # deg roll command per deg heading error

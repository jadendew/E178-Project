...
OUTPUT_CSV = r"sim_out_mlp_mpc_fixed_thrust_heading_roll_softdeadband.csv"
...
MPC_Q_PITCH = 3.0
MPC_Q_ROLL = 1.2
MPC_Q_RATES = [0.080, 0.065, 0.160]
MPC_Q_ALPHA = 0.25
MPC_Q_BETA = 0.60
MPC_R_CONTROL = [0.030, 0.030]
MPC_R_DELTA_CONTROL = [0.60, 0.60]
...
MPC_HEADING_DEADBAND_DEG = 1.0
MPC_PITCH_DEADBAND_DEG = 0.15
MPC_ROLL_DEADBAND_DEG = 0.75
MPC_ALPHA_DEADBAND_DEG = 0.25
MPC_BETA_DEADBAND_DEG = 0.25
MPC_DEADBAND_INSIDE_SCALE = 0.10  # soft deadband: inside-band errors still count at 10% strength
...
HEADING_TO_ROLL_GAIN = 0.25      # deg roll command per deg heading error during large heading changes
HEADING_TO_ROLL_DEADBAND_DEG = 2.0  # below this, heading error creates zero roll command
HEADING_TO_ROLL_FADE_FULL_DEG = 10.0 # above this, full heading-to-roll gain is used

...
OUTPUT_CSV = r"sim_out_mlp_mpc_fixed_thrust_heading_roll_deadband.csv"
...
MPC_Q_PITCH = 3.0
MPC_Q_ROLL = 1.1
MPC_Q_RATES = [0.070, 0.055, 0.100]
MPC_Q_ALPHA = 0.25
MPC_Q_BETA = 0.50
MPC_R_CONTROL = [0.025, 0.025]
MPC_R_DELTA_CONTROL = [0.45, 0.45]
MPC_LOCAL_SIGMA_DEG = [3.0, 3.0]
MPC_WARM_SIGMA_DEG = [0.8, 0.8]
MPC_WARM_START_FRACTION = 0.75

# Steady-state anti-jitter settings. These reduce optimizer dithering near trim
# without adding phase lag during the large banking/heading-capture maneuver.
MPC_HEADING_DEADBAND_DEG = 0.85
MPC_PITCH_DEADBAND_DEG = 0.30
MPC_ROLL_DEADBAND_DEG = 0.75
...
MPC_STEADY_HEADING_ERR_DEG = 1.2
MPC_STEADY_PITCH_ERR_DEG = 0.7
MPC_STEADY_ROLL_ERR_DEG = 2.5
MPC_STEADY_P_RATE_DEG_S = 6.0
MPC_STEADY_Q_RATE_DEG_S = 6.0
MPC_STEADY_R_RATE_DEG_S = 6.0
...
HEADING_TO_ROLL_GAIN = 0.35      # deg roll command per deg heading error
HEADING_TO_ROLL_DEADBAND_DEG = 1.0  # no bank command from tiny heading errors

...
import dynamicsMPC as dynamics
import propulsion
import aero
...
OUTPUT_CSV = r"sim_out_mlp_mpc_fixed_thrust.csv"
...
# MPC settings
MPC_HORIZON = 5
MPC_NUM_CANDIDATES = 60
MPC_CONTROL_PERIOD_S = 0.030       # recompute MPC every 0.03 s, hold between updates
MPC_PRED_DT = 0.030                # prediction step used inside horizon
MPC_SEED = 4
...
MPC_Q_PITCH = 3.0
MPC_Q_ROLL = 0.25
MPC_Q_RATES = [0.012, 0.020, 0.012]
MPC_Q_ALPHA = 0.15
MPC_Q_BETA = 0.50
MPC_R_CONTROL = [0.012, 0.012]
MPC_R_DELTA_CONTROL = [0.10, 0.10]
MPC_LOCAL_SIGMA_DEG = [2.5, 2.0]

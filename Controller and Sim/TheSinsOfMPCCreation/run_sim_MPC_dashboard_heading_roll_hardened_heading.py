...
OUTPUT_CSV = r"sim_out_mlp_mpc_fixed_thrust_heading_roll_hardened_heading.csv"
...
MPC_Q_PITCH = 3.0
MPC_Q_ROLL = 1.0
MPC_Q_RATES = [0.070, 0.060, 0.120]
MPC_Q_YAW_RATE_PRED = 0.010  # direct predicted-heading-rate damping in MPC rollout
MPC_Q_TERMINAL_HEADING = 14.0  # harden final heading in MPC horizon
MPC_Q_TERMINAL_PITCH = 1.0
MPC_Q_TERMINAL_ROLL = 1.0
MPC_Q_ALPHA = 0.25
MPC_Q_BETA = 0.50
MPC_R_CONTROL = [0.025, 0.025]
MPC_R_DELTA_CONTROL = [0.42, 0.42]
...
MPC_HEADING_DEADBAND_DEG = 0.35
MPC_PITCH_DEADBAND_DEG = 0.12
MPC_ROLL_DEADBAND_DEG = 0.50
MPC_ALPHA_DEADBAND_DEG = 0.25
MPC_BETA_DEADBAND_DEG = 0.25
MPC_DEADBAND_INSIDE_SCALE = 0.35  # soft deadband: inside-band errors still count at 10% strength

MPC_USE_STEADY_HOLD_RULE = True
MPC_HOLD_CMD_CHANGE_DEADBAND_DEG = 0.20
MPC_HOLD_MIN_IMPROVEMENT_FRAC = 0.02
MPC_HOLD_MAX_HEADING_ERR_DEG = 0.75  # never hold a stale command if heading error is larger than this
...
HEADING_TO_ROLL_GAIN = 0.35      # deg roll command per deg heading error during large heading changes
HEADING_TO_ROLL_DEADBAND_DEG = 0.50  # below this, heading error creates zero roll command
HEADING_TO_ROLL_FADE_FULL_DEG = 4.0 # above this, full heading-to-roll gain is used

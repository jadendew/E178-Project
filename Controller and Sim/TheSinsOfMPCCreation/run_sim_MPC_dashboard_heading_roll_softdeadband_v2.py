...
OUTPUT_CSV = r"sim_out_mlp_mpc_fixed_thrust_heading_roll_softdeadband_v2.csv"
...
MPC_Q_PITCH = 3.0
MPC_Q_ROLL = 1.0
MPC_Q_RATES = [0.070, 0.060, 0.140]
MPC_Q_YAW_RATE_PRED = 0.02  # direct predicted-heading-rate damping in MPC rollout
MPC_Q_ALPHA = 0.25
MPC_Q_BETA = 0.50
MPC_R_CONTROL = [0.025, 0.025]
MPC_R_DELTA_CONTROL = [0.50, 0.50]
...
MPC_DEADBAND_INSIDE_SCALE = 0.25  # soft deadband: inside-band errors still count at 10% strength
...
HEADING_TO_ROLL_GAIN = 0.30      # deg roll command per deg heading error during large heading changes
HEADING_TO_ROLL_DEADBAND_DEG = 1.0  # below this, heading error creates zero roll command
HEADING_TO_ROLL_FADE_FULL_DEG = 6.0 # above this, full heading-to-roll gain is used
